...
namespace potential_gap {
    class TrajectoryController {
        public:
            ...
            /**
             * @brief Generate Control law 
             * @param currentPose
             * @param Desired Odom
             * @param egocircle
             * @param offset between robot and camera frame
            ...
            /**
             * @brief Find closest pose along trajectory
             */
            int targetPoseIdx(geometry_msgs::Pose curr_pose, potential_gap::TrajPlan ref_pose);

            /**
             * @brief Convert trajectory state to contain first order differential
             */
