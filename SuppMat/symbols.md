...
| ![\theta(i)](https://latex.codecogs.com/svg.latex?\theta(i)) | angle associated with index i in ![\mathcal{L}](https://latex.codecogs.com/svg.latex?\mathcal{L}(i)) |
...
| ![l_l](https://latex.codecogs.com/svg.latex?l_l) | Distance to left side gap point |
| ![l_r](https://latex.codecogs.com/svg.latex?l_r) | Distance to right side gap point |
...
| ![\Phi(x)](https://latex.codecogs.com/svg.latex?\Phi(x)) |Attractive potential to local goal point deterined for the chosen gap. |
